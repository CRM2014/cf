...
<script src="${ctx}/resourse/js/bootstrap-datetimepicker.min.js"
	type="text/javascript"></script>
<script src="${ctx}/resourse/js/bootstrap-datetimepicker.zh-CN.js"
	type="text/javascript"></script>
<script src="${ctx}/resourse/js/json2.js" type="text/javascript"></script>
