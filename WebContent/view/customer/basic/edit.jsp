		...
		<!-- 主要内容开始 -->
			<div class="col-md-10 col-md-offset-2 main">
				...
				<div class="workpage well well-lg">
					...
					action="${ctx}/customer/customer-save.action"
					method="post" >
						<div class="form-group">
							<label for="name" class="col-sm-2 control-label">客户名称：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuName" value="${customer.cuName}">
								<input type="hidden"
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuZone" value="${customer.cuZone}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuLevel" value="${customer.cuLevel}">
							</div>
							<label for="credit" class="col-sm-2 control-label">信 用 度：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuCredit" value="${customer.cuCredit}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuPostal" value="${customer.cuPostal}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuTel" value="${customer.cuTel}">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuLegal" value="${customer.cuLegal}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-8">
								<input type="text" class="form-control" 
								name = "customer.cuWeb" value="${customer.cuWeb}">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuBank" value="${customer.cuBank}">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuRegisterCapital" value="${customer.cuRegisterCapital}">
							</div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
								<input type="text" class="form-control" 
								name = "customer.cuNationTaxNum" value="${customer.cuNationTaxNum}">
							</div>
						</div>
