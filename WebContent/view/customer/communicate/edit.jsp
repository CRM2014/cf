			...
			<div class="col-md-10 col-md-offset-2 main">
				...
				<div class="workpage well well-lg">
					<form class="form-horizontal" role="form"
						action="${ctx }/customer/cummunicate/communicate-update.action"
						method="post">
						<div class="form-group">
							...
							<input type="text" class="form-control" disabled
									value="${ contactRecord.customer.cuName}"> <input type="hidden"
									name="contactRecord.customer.cuName" value="${ contactRecord.customer.cuName}">
						</div>
						<div class="form-group">
							<label for="inputEmail3" class="col-sm-2 control-label">交往时间：</label>
							<div class="col-sm-3">
								<input type="text" class="form-control" disabled
									value="${ contactRecord.coreDate}"> <input type="hidden"
									name="contactRecord.coreDate" value="${ contactRecord.coreDate}">
							</div>
