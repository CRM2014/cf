	...
	public List findByExample(Servicecustomer instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("cf.crm.Servicecustomer")
