...
/**
 * Home object for domain model class Storage.
 * @see cf.crm.Storage
 * @author Hibernate Tools
 */
public class StorageHome {

	private static final Log log = LogFactory.getLog(StorageHome.class);
	...
	public Storage merge(Storage detachedInstance) {
		...
		try {
			Storage result = (Storage) sessionFactory.getCurrentSession()
	...
	public Storage findById(java.lang.String id) {
		...
		try {
			Storage instance = (Storage) sessionFactory.getCurrentSession()
					.get("cf.crm.Storage", id);
			if (instance == null) {
