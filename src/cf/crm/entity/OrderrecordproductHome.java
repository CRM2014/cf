 ...
 * @see src.cf.crm.entity.Orderrecordproduct
...
public class OrderrecordproductHome {
	...
	public Orderrecordproduct findById(cf.crm.entity.OrderrecordproductId id) {
		...
		try {
			Orderrecordproduct instance = (Orderrecordproduct) sessionFactory
					.getCurrentSession().get(
							"src.cf.crm.entity.Orderrecordproduct", id);
			if (instance == null) {
	...
	public List findByExample(Orderrecordproduct instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("src.cf.crm.entity.Orderrecordproduct")
